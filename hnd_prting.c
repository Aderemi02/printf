 ...
 * @fmt: Formatted string which containg list of arguments.
 * @list: List of arguments to be printed.
 * @ind: index
 * @buffer: this buffer array handles printing.
 * @flags: finds active flags
 * @width: used in geting width.
	...
	int flags, int width, int precision, int size)
{
	...
	fmt_t fmt_types[] = {
		...
		{'p', printp_pointer}, {'S', print_non_printable},
